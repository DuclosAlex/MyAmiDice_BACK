...
RETURNS TABLE (charac_name TEXT, game_name TEXT, game_status TEXT, name_user_mj TEXT, invite_status TEXT, game_id INT) AS $$
...
BEGIN
    INSERT INTO "Users" ( pseudo, email, "password", is_admin) VALUES ( new_pseudo, new_email, new_password, false, new_firstname, new_lastname) RETURNING "Users".id INTO new_id ;
