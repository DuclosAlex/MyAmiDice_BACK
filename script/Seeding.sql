...
INSERT INTO "Games" ("name", "max_players", "notes", "status", "user_id") VALUES 
    ('donjons et dragons', 4, 'partie test', 'in progress', 4),
    ('WOW', 3, 'second test', 'closed', 4);

INSERT INTO "Characters" ("firstname", "lastname", "description", "race","class", "game_id", "user_id") VALUES
    ( 'elfe', 'nain', 'archer qui tue tout', 'nainlf', 'bestkiller', 1, 2 ),
    ( 'homme', 'lézard', 'homme écailleux', 'hommzard', 'truccheelou', 2, 3);
...
INSERT INTO "Characteristics" ("strength", "dexterity", "charisma", "wisdom", "constitution", "intelligence", "level", "hp", "character_id") VALUES
    (17, 12, 8, 11, 14, 15, 7, 150, 1),
    (9, 2000, 251, 666, 42, 0, 1, 100, 2);
...
INSERT INTO "Content" ("game_id", "user_id") VALUES 
    (1,1);
